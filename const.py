...
INCREASE_DIFFICULTY_TIME = 1000 * 10
DOUBLE_BULLET_TIME = 1000*60*2
FIVE_BULLET_TIME = 1000*60*4
SEVEN_BULLET_TIME = 1000*60*6
ADD_BULLET_SPEED_TIME = 1000*60*8
ADD_BULLET_DAMAGE_TIME = 1000*60*10
ADD_BULLET_DAMAGE_LOOP_TIME = 1000*60*2
ADD_BIG_ENEMY_TIME = 1000*60*8
